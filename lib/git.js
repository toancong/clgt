...
exports.commands = {
  dateOfLatestCommit: 'git log -1 --format=%ai ',
...
exports.getLatestCommitDate = function(logs, options) {
  ...
  if (!types) {
    if (options && options.tag) {
      return format('%s (%s)', options.tag, exports.getDateOfTag(options.tag));
    }
    return '';
  }
...
exports.getDateOfTag = function(tag) {

  var stdout = child.execSync(this.commands.dateOfLatestCommit + tag);
